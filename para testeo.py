                    ...
                    if (tokens[indice] == ":"):
                        ...
                        while (tokens[indice] != "FINPRINCIPAL_"):
                            ...
                            if ((tokens[indice] == "ITERAR") and (tipo_token[indice] == "Built-In Word")):
                                indice += 1
                                if (tokens[indice] == "("):
                                    # Intuye que la variable ha sido creada y es buscada en el diccionario
                                    indice += 1
                                    if (tokens[indice] != "@ENT"):
                                        if (tokens[indice] in diccionarioVars and diccionarioVars[tokens[indice]]["tipoDato"] == "Var Entero"):
                                            print(tokens[indice]
                                                  in diccionarioVars)
                                            print(
                                                diccionarioVars[tokens[indice]]["tipoDato"])
                                            indice += 1
                                            if (tokens[indice] == ","):
                                                indice += 1
                                                if (tokens[indice] != "@ENT"):
                                                    if (tokens[indice] in diccionarioVars and diccionarioVars[tokens[indice]]["tipoDato"] == "Var Entero"):
                                                        print(
                                                            tokens[indice] in diccionarioVars)
                                                        print(
                                                            diccionarioVars[tokens[indice]]["tipoDato"])
                                                        indice += 1
                                                        if (tokens[indice] == ")"):
                                                        ...
                                                        messagebox.showerror(
                                                            "Error", f"Variable {tokens[indice]} no ha sido declarada previamente")
                                                        break
                                                else:
                                                    messagebox.showerror(
                                                        "Error", "Debe usar una variable creada en la sección de atributos")
                                                    break
                                            else:
                                                messagebox.showerror(
                                                    "Error", "Faltó una coma")
                                                break
                                        else:
                                            messagebox.showerror(
                                                "Error", f"Variable {tokens[indice]} no ha sido declarada previamente")
                                    ...
                                    messagebox.showerror(
                                        "Error", "Falta parentesis de apertura")
                                    break
                                ...
                                if (tokens[indice] in lista_variables):
                                    ...
                                    if ((tokens[indice] == "equ") and (tipo_token[indice] == "Asignación")):
                                        ...
                                        if (((tipoVar == "Var Entero") and (tipo_token[indice] == "Número")) or ((tipoVar == "Var Cadena") and (tipo_token[indice] == "Cadena")) or ((tipoVar == "Var Booleana") and (tipo_token[indice] == "Boolean"))):
                                            ...
                                            indice += 1
                                            if (tokens[indice] == "?"):
                                                diccionarioVars[tokens[mivar]
                                                                ]["valor"] = tokens[indice-1]
                                                diccionarioVars[tokens[mivar]
                                                                ]["resoluble"] = "Si"
                                                indice += 1
                                            ...
                                            # Continua evaluando <---
                                                ...
                                                messagebox.showerror(
                                                    "Error", f"Se esperaba '?' en {tokens[indice-3]} {tokens[indice-2]} {tokens[indice-1]}")
                                                break
                                                        ...
                                                        if (tokens[indice] in diccionarioVars):
                                                            if (diccionarioVars[tokens[indice]]["tipoDato"] == "Var Entero"):
                                                                if (diccionarioVars[tokens[indice]]["valor"] != ""):
                                                                    argumento1 = int(
                                                                        diccionarioVars[tokens[indice]]["valor"])
                                                                    indice += 1
                                                                else:
                                                                    messagebox.showerror(
                                                                        "Error", f"Error semántico, la variable {tokens[indice]} no se ha definido")
                                                                    break
                                                            else:
                                                                messagebox.showerror(
                                                                    "Error", f"Error semántico, el tipo de variable para el primer argumento no es Var Entero {tokens[indice]}")
                                                                break
                                                        else:
                                                            messagebox.showerror(
                                                                "Error", f"Error semántico, variable utilizada {tokens[indice]} no existe")
                                                        if (tokens[indice] == ","):
                                                            indice += 1
                                                            if (tipo_token[indice] == "Número"):
                                                                argumento2 = int(
                                                                ...
                                                                if (tokens[indice] in diccionarioVars):
                                                                    if (diccionarioVars[tokens[indice]]["tipoDato"] == "Var Entero"):
                                                                        ...
                                                                        messagebox.showerror(
                                                                            "Error", f"Error semántico, el tipo de variable para el segundo argumento no es Var Entero {tokens[indice]}")
                                                                        break
                                                                else:
                                                                    messagebox.showerror(
                                                                        "Error", f"Error semántico, variable utilizada {tokens[indice]} no existe")
                                                                if (tokens[indice] == ")"):
                                                                    ...
                                                                    if (tokens[indice] == "?"):
                                                                        ...
                                                                        if (tokens[tipoOperador] == "*MAS"):
                                                                            diccionarioVars[tokens[mivar]]["valor"] = (
                                                                        ...
                                                                        messagebox.showerror(
                                                                            "Error", f"Error de sintáxis, se esperaba '?' en {tokens[indice-2]} {tokens[tokens-1]} {tokens[indice]}")
                                                                        break
                                                                else:
                                                                    messagebox.showerror(
                                                                        "Error", f"Error de sintáxis, se esperaba cierre ')' en {tokens[indice-2]} {tokens[indice-1]} {tokens[indice]}")
                                                                    break
                                                            else:
                                                                messagebox.showerror(
                                                                    "Error", f"Error semántico, se esperaba un dígito para segundo argumento de operador de tipo aritmético en {tokens[indice-2]} {tokens[indice-1]} {tokens[indice]} ")
                                                                break
                                                        else:
                                                            messagebox.showerror(
                                                                "Error", f"Error de sintáxis, se eperaba separador ',' en {tokens[indice-2]} {tokens[indice-1]} {tokens[indice]}")
                                                            break
                                                    else:
                                                        messagebox.showerror(
                                                            ...
                                                            if (tipo_token[indice] == "Número"):
                                                                ...
                                                                if (tokens[indice] == ")"):
                                                                    ...
                                                                    if (tokens[indice] == "?"):
                                                                        indice += 1
                                                                        messagebox.showinfo(
                                                                            "SIU", "Evalué operador relacional")
                                                                        ...
                                                                        messagebox.showerror(
                                                                            "Error", f"Error de sintáxis, se esperaba '?' en {tokens[indice-2]} {tokens[indice-1]} {tokens[indice]}")
                                                                else:
                                                                    messagebox.showerror(
                                                                        "Error", f"Error de sintáxis, se esperaba ')' en {tokens[indice-2]} {tokens[indice-1]} {tokens[indice]}")
                                                                    break
                                                                ...
                                                                messagebox.showerror(
                                                                    "Error", f"Error semántico, se esperaba segundo argumento de tipo numérico en {tokens[indice-2]} {tokens[tokens-1]} {tokens[indice]}")
                                                                break
                                                        else:
                                                            messagebox.showerror(
                                                                "Error", f"Error de sintáxis, se esperaba separador ',' en {tokens[indice-2]} {tokens[indice-1]} {tokens[indice]}")
                                                            break
                                                    else:
                                                        messagebox.showerror(
                                                            "Error", f"Error semántico, se esperaba primer argumento de tipo numérico en {tokens[indice-2]} {tokens[indice-1]} {tokens[indice]}")
                                                        break
                                                else:
                                                    messagebox.showerror(
                                                        "Error", f"Error de sintáxis, se esperaba '(' en {tokens[indice-2]} {tokens[indice-1]} {tokens[indice]}")
                                    ...
                                    if (tokens[indice] == "=ESMAYOR" or tokens[indice] == "=ESMENOR" or tokens[indice] == "=ESIGUAL" or tokens[indice] == "=NOIGUAL"):
                                        ...
                                        if (tokens[indice] == "("):
                                            ...
                                            if (tokens[indice] != "@ENT" or tokens[indice] != "@CAD" or tokens[indice] != "@BULL"):
                                                ...
                                                if (tokens[indice] in diccionarioVars and diccionarioVars[tokens[indice]]["tipoDato"] == "Var Entero"):
                                                    # Recuperan valor de la primer variable
                                                    val1 = int(
                                                        diccionarioVars[tokens[indice]]["valor"])
                                                    print(val1)
                                                    indice += 1
                                                    if (tokens[indice] == ","):
                                                        ...
                                                        if (tokens[indice] != "@ENT" or tokens[indice] != "@CAD" or tokens[indice] != "@BULL"):
                                                            if (tokens[indice] in diccionarioVars and diccionarioVars[tokens[indice]]["tipoDato"] == "Var Entero"):
                                                                # Recuperando valor del segundo parámetro
                                                                val2 = int(
                                                                    diccionarioVars[tokens[indice]]["valor"])
                                                                print(val2)
                                                                indice += 1
                                                                if (tokens[indice] == ")"):
                                                                    ...
                                                                    if (tokens[indice] == ")"):
                                                                        ...
                                                                        if (tokens[indice] == ":"):
                                                                            #indice += 1
                                                                            # AQUI VA LA COMPROBACIÓN CUANDO SALTE A "JALO:"
                                                                            #"=ESMAYOR", "=ESMENOR", "=ESIGUAL", "=NOIGUAL"
                                                                            if (operador == "=ESMAYOR"):
                                                                                banderaSalto = val1 > val2
                                                                                print(
                                                                                    f"Entro en esmayor {banderaSalto}")
                                                                            elif (operador == "=ESMENOR"):
                                                                                banderaSalto = val1 < val2
                                                                                print(
                                                                                    f"Entro en esmenor {banderaSalto}")
                                                                            elif (operador == "=ESIGUAL"):
                                                                                banderaSalto = val1 == val2
                                                                                print(
                                                                                    f"Entro en esigual {banderaSalto}")
                                                                            elif (operador == "=NOIGUAL"):
                                                                                banderaSalto = val1 != val2
                                                                                print(
                                                                                    f"Entro en noigual {banderaSalto}")
                                                                            # -------------AQUI VA LA COMPROBACIÓN CUANDO SALTE A "JALO:"-------------#
                                                                            if(banderaSalto == True):
                                                                                indice+=1
                                                                                if(tokens[indice]=="JALO"):
                                                                                    ...
                                                                                    if(tokens[indice]==":"):
                                                                                        ...
                                                                                        while (tokens[indice] != "FINJALO_"):
                                                                                            ...
                                                                                            break
                                                                                        indice+=1
                                                                                        messagebox.showinfo("Aviso","Se evaluó el JALO")
                                                                                        if(tokens[indice]=="NOJALO"):
                                                                                            indice+=1
                                                                                            if(tokens[indice]==":"):
                                                                                                indice+=1
                                                                                                if(tokens[indice]=="FINNOJALO_"):
                                                                                                    indice+=1
                                                                                                    if(tokens[indice]=="FINSI_"):
                                                                                                        indice+=1
                                                                                                        break
                                                                                                    else:
                                                                                                        messagebox.showerror("Error","Falta cierre de SI():")
                                                                                                        break
                                                                                                else:
                                                                                                    messagebox.showerror("Error","Falta FINNOJALO_")
                                                                                                    break
                                                                                            else:
                                                                                                messagebox.showerror("Error","Falta ':'")
                                                                                                break
                                                                                        else:
                                                                                            messagebox.showerror("Error","Falta no JALO")
                                                                                            break
                                                                                    else:
                                                                                        messagebox.showerror("Error","Se espereba ':'")
                                                                                        break
                                                                                else:   
                                                                                    messagebox.showerror("Error","Se espereba JALO")
                                                                                    break
                                                                            else:
                                                                                indice+=1
                                                                                if(tokens[indice]=="JALO"):
                                                                                            ...
                                                                                            if(tokens[indice]=="NOJALO"):
                                                                                                ...
                                                                                                if(tokens[indice]==":"):
                                                                                                    ...
                                                                                                    while(tokens[indice]!="FINNOJALO_"):
                                                                                                        ...
                                                                                                        break
                                                                                                    indice+=1
                                                                                                    messagebox.showinfo("AVISO","Se evaluó el NOJALO")
                                                                                                    if(tokens[indice]=="FINSI_"):
                                                                                                        indice+=1
                                                                                                        break
                                                                                                    else:
                        ...
                        if (tokens[indice] == "HASTAAQUILAVAMOSADEJAR_"):
                            messagebox.showinfo(
                                "EXITO", "PROGRAMA COMPILADO CORRECTAMENTE")
                        else:
                            messagebox.showerror(
                                "Error", f"Se esperaba cierre de clase 'HASTAAQUILAVAMOSADEJAR_'")
                    else:
                        messagebox.showerror(
...
LabelTitle = Label(Frame1, text="COMPILADOR FINAL - LENGUAJES AUTÓMATAS 2", font=(
...
botonañadir = Button(Frame1, text="P", command=lambda: getTextInput(
    textoComentario.get("1.0", "end"), tokens, tipo_token))
